...
$(function(){
	...
	$(document).on("rex:ready", function() { fmBS_getBlockSettings(); });				//Settings bei AJAX-Aktion einbinden
	fmBS_getBlockSettings();															//Settings bei URL-Direktaufruf einbinden
	fmBS_initPlugins();
	
	function fmBS_getBlockSettings()
